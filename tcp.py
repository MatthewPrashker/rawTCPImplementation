...
class TCP:
  ...
  def __init__(self, source_ip: IPv4Address, dest_ip: IPv4Address,source_port: int, dest_port: int, seq_num: int, ack_num: int, window_size: int, flags: int, payload: bytes):
  ...
  def calculate_checksum(self) -> bytes:
    ...
    return gen_checksum(ip_pseudo+header_with_zero_checksum+self.options+self.payload)
